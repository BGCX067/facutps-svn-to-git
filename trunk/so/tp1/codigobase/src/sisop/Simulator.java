...
final class Simulator {
  ...
  private static Map<String, Scheduler> build_schedulers() {
    ...
    schedulers.put(mfq_io.get_name(), mfq_io);
  ...
  */
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      double avg_wtime = analyzer.get_avg_wtime();
  ...
  private static void write_to_file(List<String> timeline, String scheduler_name, String task_set_name) {
